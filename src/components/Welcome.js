  ...
  return (
    <div className="flex flex-col items-center justify-start h-screen">
      ...
      <div className="flex flex-col items-center justify-center pt-20">
        ...
        <h1 className="text-white mb-10 text-2xl sm:text-3xl md:text-4xl" style={{ fontFamily: 'Lilita One, cursive'}}>Welcome to the Code Side, {userName}!</h1>

        <h2 className="text-[#B2D7E8] mb-10 text-sm sm:text-2xl md:text-3xl font-semibold">Logged in with {authProvider}</h2>
